...
import { logoBiggie, paymentLogo } from '../assets'
    ...
    <div className='bg-black text-[#949494] py-20 font-titleFont'>
        <div className='max-w-screen-xl mx-auto grid grid-cols-4'>
            <div className='flex flex-col gap-5'>
                <img className='w-32' src={logoBiggie} alt='logoBiggie'></img>
                <p className='text-white text-sm tracking-wide'>© ReactBD.com</p>
                <img className='w-32' src={paymentLogo} alt='paymentLogo' />
